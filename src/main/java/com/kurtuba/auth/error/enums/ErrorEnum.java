...
public enum ErrorEnum {
    ...
    USER_EMAIL_NOT_VERIFIED("User email is not verified",1305),
    USER_EMAIL_VERIFICATION_STATUS_INVALID("Email already verified or user doesn't exist",1306),
    USER_EMAIL_VERIFICATION_CODE_INVALID("Wrong email verification code",1307),
    USER_EMAIL_VERIFICATION_CODE_EXPIRED("Email verification code expired",1308),
